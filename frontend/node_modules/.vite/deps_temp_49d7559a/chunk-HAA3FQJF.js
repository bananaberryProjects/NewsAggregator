...
// node_modules/@mui/utils/formatMuiErrorMessage/formatMuiErrorMessage.mjs
...
margin.propTypes = false ? Array.from(marginKeys).reduce((obj, key) => {
...
padding.propTypes = false ? Array.from(paddingKeys).reduce((obj, key) => {
  obj[key] = responsivePropType_default;
  return obj;
}, {}) : {};
...
spacing.propTypes = false ? Array.from(spacingKeys).reduce((obj, key) => {
  obj[key] = responsivePropType_default;
  return obj;
}, {}) : {};
...
@mui/system/index.mjs:
   ...
   *)
*/
//# sourceMappingURL=chunk-HAA3FQJF.js.map
